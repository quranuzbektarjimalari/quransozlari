...
# Excel fayldan audio nomini topish funksiyasi
...
# Linkdan audio yuklab olish va yuborish
...
# Telegram botga handlerlar qo‘shish
...
def home():
    return "Bot ishlayapti! Bu asosiy sahifa."
